...
import { fetchSubSportCategories, sportCatTitleChange, sportCatImageUrlChange, addSportSubCategories } from '../../actions/sportsAction';
...
class SportSubCategories extends Component {
    componentWillMount() {
        ...
        this.props.fetchSubSportCategories(item.id)
    }
    ...
    onAddSportCategories = () => this.props.addSportSubCategories(this.props.sportCatTitleValue, this.props.sportCatImageUrlValue, this.props.location.item.id)

    render() {
        const {  subSportCatValues, sportSpinnerStatus, sportCatTitleValue, sportCatImageUrlValue, sportWarningStatus } = this.props;
        return (
            <Container>
                {
                ...
                <Table celled selectable inverted>
                    ...
                    <Table.Body>
                    {
                        subSportCatValues.map((item, index) => {
                        return(
                            ...
                            <Table.Cell collapsing>
                                ...
                                <Button as={Link} to={{
                                pathname: "/sports/sub-cats/tab-title",
                                item: item
...
const mapStateToProps = state => {
    const { sportCatTitleValue, sportCatImageUrlValue, sportSpinnerStatus, subSportCatValues, sportWarningStatus } = state.SportReducer;
    return {
        sportCatTitleValue,
...
export default connect(
    mapStateToProps,
    {
        fetchSubSportCategories,
        sportCatTitleChange,
        sportCatImageUrlChange,
        addSportSubCategories
    }
)(SportSubCategories)